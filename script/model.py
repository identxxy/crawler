...
class Model(nn.Module):
    def __init__(self, num_inputs, num_outputs):
        ...
        self.p_fc0 = nn.Linear(num_inputs, h_size_1)
        self.p_fc1 = nn.Linear(h_size_1, h_size_1)
        self.p_fc2 = nn.Linear(h_size_1, h_size_2)

        self.v_fc0 = nn.Linear(num_inputs, h_size_1)
        self.v_fc1 = nn.Linear(h_size_1, h_size_1*5)
