...
import rospy
from Training_T import *
# import pybullet_envs
from ACNet_T import acNetCell, load_checkpoint, Shared_obs_stats
...
parser.add_argument('--env_name',      type=str,   default="CrawlerWalkXCamEnv-v3", help='env_name');
...
parser.add_argument('--actorsize',   type=int,   default=100,  help='Embedding size in the gru layer');
...
def main():
    ...
    num_inputs = 60
    num_outputs = 16
    model = acNetCell(num_inputs, num_outputs, params.hiddensize, params.gruhiddensize, params.actorsize, params.iso_sig).to(device)
